...
AppName=Hookshot
AppVerName=Hookshot Version 0.1
...
DefaultDirName={pf}\DigiPen\Hookshot

; Start menu directory
DefaultGroupName=DigiPen\Hookshot

; Output directory for the installer.
OutputDir=.\INSTALLER

; Setup executable installer
OutputBaseFilename=Hookshot_Setup
...
[Icons]
Name: {group}\Hookshot\Hookshot; Filename: {app}\Hookshot.exe; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
Name: {group}\{cm:UninstallProgram,Hookshot}; Filename: {uninstallexe}
Name: {commondesktop}\Hookshot; Filename: {app}\Hookshot\Hookshot.exe; Tasks: desktopicon; WorkingDir: {app}\Hookshot; IconFilename: "{app}\Icon.ico"
...
Filename: {app}\Hookshot\Hookshot.exe; Description: {cm:LaunchProgram,Hookshot}; Flags: nowait postinstall skipifsilent
